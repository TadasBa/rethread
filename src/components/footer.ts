  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h("a.footer__link", { href: "/kaip-tai-veikia" }, S.nav.how),
      ...
      h(
        ...
        h("a.footer__link", { href: "/privatumo-politika" }, S.footer.privacy),
        h("a.footer__link", { href: "/taisykles" }, S.footer.terms),
        h("a.footer__link", { href: "/pristatymas-ir-grazinimas" }, S.footer.shipping),
        h("a.footer__link", { href: "/garantija" }, S.how.guaranteeTitle),
      ),
    ),
    h(
